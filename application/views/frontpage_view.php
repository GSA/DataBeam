...
<h1>Welcome to DataBeam</h1>
		...
		<p>Each instance is meant to be multiuser with Github for user authentication and you're free to use this instance by <a href="/databeam/login">logging in</a>, but it's also very easy to install your own copy with these basic requirements:</p>
        <ul>
            <li>PHP 5.3</li>
